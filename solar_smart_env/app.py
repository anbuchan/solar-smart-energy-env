...
# Ensure we can import from parent directory if needed, but since we are inside solar_smart_env, 
# we should be able to import local env.py directly.
...
if __name__ == "__main__":
    uvicorn.run("solar_smart_env.app:app", host="0.0.0.0", port=7860, reload=False)